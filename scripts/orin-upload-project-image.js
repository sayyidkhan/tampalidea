...
process.stdin.on("end", async () => {
  try {
    ...
    const response = await fetch(`${endpoint}/api/projects/${slug}/attachments`, { method: "POST", headers: { "Content-Type": "application/json", Accept: "application/json" }, body: JSON.stringify(body) });
