...
process.stdin.on("end", async () => {
  try {
    ...
    const response = await fetch(`${endpoint}/api/projects/${slug}/attachments/${attachmentId}/cover`, { method: "POST", headers: { Authorization: `Bearer ${token}`, "Content-Type": "application/json", Accept: "application/json" }, body: JSON.stringify(body) });
